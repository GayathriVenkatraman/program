# Building 3 Tier Web Apps on AWS

This module teaches students how to build scalable 3-tier web applications using AWS services, covering presentation, application, and data layers.
